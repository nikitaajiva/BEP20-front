    ...
    <div className={styles.rwCardWrapper}>
      ...
      <div className={styles.rwBody}>
        ...
        <div className={styles.rwFooter}>
          <div className={styles.rwCurrentBalanceCol}>
             <div className={styles.rwAccumulatedLabel}>CURRENT BALANCE</div>
             <div className={styles.rwCurrentValue}>{currentBalance}</div>
          </div>
          <button className={styles.rwAutoPosBtn} onClick={onAutoPosition}>
