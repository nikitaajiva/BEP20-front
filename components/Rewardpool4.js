...
import Rewardwatch from "../public/assets/img/poolbanner/pngimgcomhyundai.png";
export default function Rewardpool4() {
  return (
    <div className="pool-box Rewardpool4-style pool-box-background">
      {/* Left Image */}
      ...
      <div className="pool-content">
        ...
        <div className="pool-text">
          <h3 className="title">REWARD POOL 4</h3>

          <h2 className="heading">
            Have 60 iPhone 17 Pro <br />
          ...
          <h1 className="reward-line-inner">Worth 11,000 USDT</h1>
          <p className="note">
