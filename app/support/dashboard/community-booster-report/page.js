  ...
  return (
    <div style={{ padding: '2rem', maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ 
        ...
        <h2 style={{ color: '#4f8cff', marginBottom: '1.5rem' }}>Community Booster Report</h2>
            ...
            {modalData && (
              <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', color: '#fff' }}>
                  <thead>
                    <tr style={{ background: 'rgba(79, 140, 255, 0.1)' }}>
                      <th style={{ padding: '1rem', textAlign: 'left', color: '#b3baff' }}>Reward Time</th>
                      <th style={{ padding: '1rem', textAlign: 'left', color: '#b3baff' }}>Deposit Time</th>
                      <th style={{ padding: '1rem', textAlign: 'left', color: '#b3baff' }}>From User</th>
                      <th style={{ padding: '1rem', textAlign: 'right', color: '#b3baff' }}>Deposit Amount</th>
                      <th style={{ padding: '1rem', textAlign: 'right', color: '#b3baff' }}>Bonus Amount</th>
                      <th style={{ padding: '1rem', textAlign: 'center', color: '#b3baff' }}>Level</th>
                      <th style={{ padding: '1rem', textAlign: 'center', color: '#b3baff' }}>Tier</th>
                      <th style={{ padding: '1rem', textAlign: 'right', color: '#b3baff' }}>Rate</th>
                    </tr>
                  </thead>
                  <tbody>
      ...
      {showQualificationModal && (
        <div style={modalStyle}>
          <div style={modalContentStyle}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              <h3 style={{ color: '#4f8cff', margin: 0 }}>Qualification Requirements</h3>
              <button
            ...
            <div style={{ overflowX: 'auto' }}>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', color: '#fff' }}>
                <thead>
                  <tr style={{ background: 'rgba(79, 140, 255, 0.1)' }}>
                    <th style={{ padding: '1rem', textAlign: 'left', color: '#b3baff' }}>Tier</th>
                    <th style={{ padding: '1rem', textAlign: 'center', color: '#b3baff' }}>Level</th>
                    <th style={{ padding: '1rem', textAlign: 'center', color: '#b3baff' }}>Min Directs</th>
                    <th style={{ padding: '1rem', textAlign: 'right', color: '#b3baff' }}>Min Self LP</th>
                    <th style={{ padding: '1rem', textAlign: 'right', color: '#b3baff' }}>Direct Volume</th>
                    <th style={{ padding: '1rem', textAlign: 'right', color: '#b3baff' }}>Team Volume</th>
                    <th style={{ padding: '1rem', textAlign: 'center', color: '#b3baff' }}>Status</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    { tier: 10000, level: 1, minDirects: 1, minSelfLP: 9, directRequired: 2000, teamRequired: 10000, baseRate: 0.12 },
                    { tier: 20000, level: 2, minDirects: 2, minSelfLP: 9, directRequired: 6000, teamRequired: 20000, baseRate: 0.10 },
                    { tier: 30000, level: 3, minDirects: 3, minSelfLP: 9, directRequired: 12000, teamRequired: 30000, baseRate: 0.07 }
                  ].map((tierReq, index) => {
                    const meetsBasicReqs = (summary.conditions?.directs >= tierReq.minDirects) && 
                                         (parseFloat(summary.conditions?.selfLP) >= tierReq.minSelfLP);
                    ...
                    return (
                      <tr key={index} style={{ borderBottom: '1px solid rgba(79, 140, 255, 0.1)' }}>
                        ...
                        <td style={{ padding: '1rem', textAlign: 'center' }}>Level {tierReq.level}</td>
                        <td style={{ padding: '1rem', textAlign: 'center', color: summary.conditions?.directs >= tierReq.minDirects ? '#4caf50' : '#ff4d4d' }}>
              ...
              <div style={{ marginTop: '1rem', color: '#b3baff', fontSize: '0.9em' }}>
                <p>Note: To qualify for a tier, you must meet ALL requirements:</p>
                <ol style={{ paddingLeft: '1.5rem' }}>
                  <li>Have the minimum number of direct referrals for that level</li>
                  <li>Maintain the minimum self LP balance</li>
                  <li>Meet the direct volume requirement (from Level 1 team)</li>
