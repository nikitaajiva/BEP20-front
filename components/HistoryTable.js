      ...
      try {
        ...
        if (data.success) {
          ...
          if (data?.totals) {
            ...
            setTotalWithdrawals(data.totals.totalWithdrawals);
          }
  ...
  return (
    ...
    >
      <div className="USDT_total_headding">
        ...
        >
          <p className="content_p_deposits">Total Added:</p>
        ...
        >
          <p className="content_p_withdrawals">Total LP Positioning:</p>
          <span>{totalLPPoistioning}</span>
        </div> */}
        {/* <div
          style={{
            color: "#7FFF4C",
              ...
              >
                ...
                >
                  ...
                  {/* {entry.eventType === 'BOOST_BONUS'
                    ...
                    : entry.ratePct ? `${entry.ratePct}%` : 'N/A'} */}
                </td>
                {/* <td
                  style={{
                    padding: "1.25rem 1rem",
