            ...
            <tbody>
              {entries.map((entry, index) => (
                ...
                >
                  ...
                  >
                    {parseFloat(
                      entry?.ledgerDetails?.limits?.zeroRiskLimit?.cap
                        ?.$numberDecimal || "0"
                    ) -
                      parseFloat(
                        entry?.ledgerDetails?.wallets?.communityRewards
                          ?.$numberDecimal || "0.0"
                      ) -
                      parseFloat(
                        entry?.ledgerDetails?.totalRewardsWithdrawal
                          ?.$numberDecimal || "0.0"
                      )}
                  </td>
                  <td
                  ...
                  >
                    {parseFloat(
                      entry?.ledgerDetails?.wallets?.lp?.$numberDecimal || "0"
                    )}
                  </td>
                  ...
                  >
                    {parseFloat(
                      entry?.ledgerDetails?.limits?.fiveXLimit?.used
                        ?.$numberDecimal || "0"
                    )}
                  </td>
                  ...
                  >
                    {" "}
                    {renderWalletCell(entry.wallets, "AUTOPOSITIONING", index)}
                  </td>
                  <td
                    style={{
                      padding: "1.25rem 1rem",
