...
export default function InvitationLinkCard({ user }) {
  ...
  const socialButtonStyle = {
    ...
    gap: "0.5rem",
    borderRadius: "12px",
    padding: "0.5rem", // Adjusted padding for smaller buttons if desired
    transition: "all 0.3s ease",
    textDecoration: "none",
    fontWeight: 500,
    flex: "1", // Make buttons take equal space in the grid
    fontSize: "0.875rem",
  };
  ...
  return (
    <div className="card h-100" style={cardBaseStyle}>
      <div
        className="card-body p-0 d-flex flex-column h-100"
      ...
      >
        ...
        >
          <div className="mb-auto">
            ...
            <div
              className="invite-input-group mb-2 mx-auto"
            ...
            >
              ...
              />
              <div className="invite-input-group-divider"></div>
              <button
            ...
            {!copySuccess && (
              <div style={{ height: "1.2em", marginTop: "0.5rem" }}>&nbsp;</div>
            )}
            ...
            <div className="social-icons-container">
              {/* <a
                href="https://x.com/BEPVault"
                target="_blank"
                rel="noopener noreferrer"
                className="btn social-icon-btn"
                style={{
                  ...socialButtonStyle,
              ...
              <a
                href="https://www.youtube.com/@BEPVaultChannel"
                target="_blank"
                rel="noopener noreferrer"
                className="btn social-icon-btn"
                style={{
              ...
              <a
                href="https://www.instagram.com/BEPVault"
                target="_blank"
                rel="noopener noreferrer"
                className="btn social-icon-btn"
                style={{
          ...
          <div
            className="mt-auto pt-2 d-flex justify-content-center align-items-center"
            style={{ flexGrow: 1, minHeight: "80px" }}
          >
            <img
              src="/assets/img/elements/USDT-paper.png"
              alt="USDT Logo"
              style={{
                display: "block",
                maxHeight: "clamp(80px, 90%, 150px)",
                maxWidth: "80%",
                width: "auto",
                height: "auto",
                objectFit: "contain",
