    ...
    <>
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
        ...
        {!showSuccess && (
          ...
          >
            {/* Top Glow */}
            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 250, background: "radial-gradient(circle at 50% -20%, rgba(255,85,0,0.2), transparent 70%)", zIndex: -1, pointerEvents: "none" }} />
            ...
            <div style={{ textAlign: "center", marginBottom: 30 }}>
              ...
              <h2 style={{ fontSize: 26, fontWeight: 900, margin: 0, letterSpacing: "-0.5px", textTransform: "uppercase", color: "#fff", textShadow: "0 4px 20px rgba(0,0,0,0.5)" }}>Staking Engine</h2>
            </div>
              ...
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
                ...
                <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,85,0,0.2)", borderRadius: 20, padding: 20, marginBottom: 20 }}>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                    ...
                    <div style={{ background: "rgba(0,0,0,0.3)", padding: "12px 14px", borderRadius: 14, border: "1px solid rgba(255,85,0,0.2)", textAlign: "center" }}>
                      ...
                      <div style={{ fontSize: 15, fontWeight: 900, color: "#ff5500" }}>{remainingSol} SOL</div>
                ...
                {!qrDataUrl ? (
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "20px 0" }}>
                    ...
                    <button onClick={() => { setStep(2); setActivationError(""); }} style={{ width: "100%", padding: 16, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 16, color: "#fff", fontWeight: 800, fontSize: 14, cursor: "pointer" }}>Back</button>
                  </div>
                ) : (
