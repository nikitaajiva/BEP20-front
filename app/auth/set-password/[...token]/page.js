...
function SetPasswordPage() {
  ...
  // For a route like /auth/set-password/abc, params would be { token: 'abc' }
  // For a catch-all route like /auth/set-password/[...token], params would be { token: ['abc'] }
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await setPassword({ password, confirmPassword, token });
    
    // The setPassword function in AuthContext handles redirection on success.
    // If it fails, the error will be set in the context and displayed.
  };
