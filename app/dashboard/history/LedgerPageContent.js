...
export default function LedgerPageContent() {
  ...
  if (error) {
    return (
      <div className="container-xxl flex-grow-1 container-p-y py-4">
        <div className="alert alert-danger" style={{backgroundColor: '#450A0A', color: '#F9DADA', border: '1px solid #7F1D1D'}}>
          {error}
        </div>
      </div>
    );
      ...
      <div className="container-xxl flex-grow-1 container-p-y py-4">
        <div className="row mb-4">
          <div className="col-12">
            <h2 className="fw-bold mb-3" style={{ color: '#fff', fontSize: '1.75rem' }}>{getFilterTitle()}</h2>
          </div>
        </div>
        ...
        <div className="card p-4 mb-4" style={{ 
          ...
          <div style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
            ...
            <div>
              <label htmlFor="startDate" className="form-label mb-2" style={{ color: '#b3baff', fontWeight: 500 }}>Start Date</label>
              <input 
                type="date"
                id="startDate"
                name="startDate"
            ...
            <div>
              <label htmlFor="endDate" className="form-label mb-2" style={{ color: '#b3baff', fontWeight: 500 }}>End Date</label>
              <input 
                type="date"
                id="endDate"
                name="endDate"
        ...
        <div className="card p-4 mb-4" style={{ 
          ...
          <h4 className="fw-bold mb-4" style={{ fontSize: '1.25rem', color: '#fff' }}>Transaction History</h4>
