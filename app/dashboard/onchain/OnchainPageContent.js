...
const transaction_type = ["DEPOSIT","WITHDRAWAL"];
...
export default function OnchainPageContent() {
  ...
  const getFilterTitle = () => {
    if (filters.eventType === "all") return "Onchain Transactions";
  ...
  if (error) {
    return (
      <div className=" container-p-y py-4">
        <div
