...
export default function OnChainTable({ filters }) {
    ...
    const fetchChainHistory = async () => {
      ...
      try {
        ...
        const queryParams = new URLSearchParams({
          ...
          ...(filters.eventType && { entryType: filters.eventType }),
          ...(filters.startDate && { startDate: filters.startDate }),
          ...(filters.endDate && { endDate: filters.endDate }),
        });

        const apiUrl = `${API_URL}/onchain?${queryParams.toString()}`
          .replace(/\/+/g, "/")
          .replace(":/", "://");
  ...
  return (
    ...
    >
      <div className="USDT_total_headding">
        ...
        >
          <p className="content_p_deposits"> Total Deposits:</p>
        ...
        >
          <p className="content_p_withdrawals"> Total Withdrawals:</p>
              ...
              >
                ...
                <td style={{ padding: "1.25rem 1rem", border: "none" }}>
                  <span
                    style={{
                      ...
                      fontSize: "0.85rem",
                      padding: "0.4rem 0.8rem",
                      background: `${getEventTypeColor(entry.type)}15`,
                      borderRadius: "6px",
                      display: "inline-block",
                      border: `1px solid ${getEventTypeColor(entry.type)}30`,
                    }}
                  >
                ...
                <td
                  style={{
                    ...
                    border: "none",
                    color:
                      parseFloat(entry.amountUSDT) >= 0 ? "#7FFF4C" : "#ff4d4d",
                    fontWeight: 700,
                    fontSize: "0.95rem",
                    textAlign: "right",
                  }}
                >
                  {parseFloat(entry.amountUSDT).toFixed(6)}
                </td>
                <td
                  style={{
                    padding: "1.25rem 1rem",
                ...
                >
                  <RefIdDisplay refId={entry.txHash} />
                </td>
              </tr>
            ))}
          </tbody>
