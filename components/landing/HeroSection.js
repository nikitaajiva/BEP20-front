...
const HeroSection = () => {
  ...
  const socials = [
    ...
    {
      href: "https://facebook.com/BEPVaultOfficial",
    ...
    {
      href: "https://medium.com/@BEPVault",
  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide>
          <section
            className="banner_section_2  hero_swiper_Style"
            style={heroStyle}
          >
            <BlockHeroSection />
          </section>
        ...
        <SwiperSlide>
          <section
            className="banner_section_3 hero_swiper_Style"
            style={heroStyle}
          >
                ...
                <section class="event-section">
                  <div class="event-container">
                    <div class="event-content">
                      ...
                      <div className="mt-5 ico_btn_outline_outer">
                        {" "}
        ...
        <SwiperSlide>
          <section
            className="banner_section_4 hero_swiper_Style"
            style={heroStyle}
          >
            <div className="event-section-main min-h-screen bg-black text-white flex items-center px-6 md:px-20 py-12">
              <div className="main-outer-section grid md:grid-cols-2 gap-3 items-center w-full mx-auto">
                <section class="event-section">
                  <div class="event-container">
                    <div class="event-content">
                      <div className="event-content-inner">
                        <h1 class="event-title">
                          Bridge to the New Financial Horizon
                        </h1>
                      </div>
                      <p class="event-description">
